...
# 3-tier application deployed using 3 different EC2 instances

## 1. Architecture
![Architecture Image 1](https://github.com/user-attachments/assets/285e9453-0a10-47f7-b7ec-876b6a735e74)
![Architecture Image 2](https://github.com/user-attachments/assets/a7104f8b-79f9-44b5-8fd1-0280ac7da365)

I created the presentation layer instance under the presentation layer subnet. Similarly, the application layer instance was created under the application-layer subnet, and the database layer instance was created under the database-layer subnet.
...
These commands perform a series of tasks such as updating the system, installing necessary packages, cloning the repository, setting up PostgreSQL with remote access, and testing database connectivity.
...
![Database and Backend Connectivity](https://github.com/user-attachments/assets/d3c200d3-4843-4983-88f1-7cd8342c9f7e)

### Frontend and Backend Connectivity:
![Frontend and Backend Connectivity](https://github.com/user-attachments/assets/11685fbb-a4ca-45d6-8743-ab47ea0fef62)
